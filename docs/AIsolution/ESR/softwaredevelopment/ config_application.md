...
2. 工程项目是使用 `lisa` 创建的 CSK 项目（文档参考：[使用 lisa 创建项目](/)）

**温馨提示**： LStudio 旧项目的基础配置使用说明请查看：[CSK项目基础配置](/)
...
| 通用双工协议 | 非自定义的双工协议，建议在离在线方案中使用。只支持串口通讯，不支持红外通讯。<br/>参考：[CSK UART标准串口通信协议文档](/) | 
