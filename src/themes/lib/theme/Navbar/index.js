...
var _LsToggle = _interopRequireDefault(require("@theme/LsToggle"));
  ...
  return <nav ref={navbarRef} className={(0, _clsx.default)('navbar', 'navbar--fixed-top', {
    ...
    [_stylesModule.default.navbarHidden]: hideOnScroll && !isNavbarVisible
      ...
      <div className="navbar__inner">
        ...
        // />
        <_LsToggle.default className={_stylesModule.default.displayOnlyInLargeViewport} checked={isDarkTheme} onChange={onToggleChange} />}
      ...
      <div className="navbar-sidebar">
        <div className="navbar-sidebar__brand">
          ...
          {!disableColorModeSwitch && sidebarShown && <_LsToggle.default checked={isDarkTheme} onChange={onToggleChange} />}
        </div>
